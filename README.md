...
As version 1.0.0 the code has been decoupled from the CodeIgniter framework. If you want to use the initial [CodeIgniter
library, please check the 0.1.0 release](https://github.com/piotrpolak/codeigniter-symfony2-bridge/tree/0.1.0).
